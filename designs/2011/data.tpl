...
header div.header {
	...
	min-width: 600px;
	height: 200px;
	background: #ffffff url('2011/header-2011.png');
}
* html header .wrapper {
	width: 800px;
...
header #search input[type=text] {
	...
	top: 0;
	left: 36px;
	background: #ffffff url('2011/searchbox-text-2011.png');
}
header #search input[type=submit] {
	...
	top: 0;
	left: 0;
	background: #ffffff url('2011/searchbox-submit-2011.png');
}
...
#banner div.banner-image {
	...
	min-width: 600px;
	height: 283px;
	background: url('2011/lantern-2011.jpg');
	margin: 0 auto;
	border-top: 0 solid;
	border-right: 0 solid;
	border-bottom: 0 solid;
...
nav#nav ul {
	background: #111111 url('2011/menu_background-2011.png') center;
	max-width: 1000px;
	min-width: 600px;
	height: 47px;
	list-style: none;
...
nav#nav li {
	...
	margin: 0 0 5px;
	padding: 0;
	background: #111111 url('2011/menu_background-2011.png');
}
...
nav#nav li:hover a {
	...
	font-style: normal;
	text-decoration: none;
	background: #cccccc url('2011/menu_hover-2011.png');
}
...
footer div.footer {
	...
	min-width: 600px;
	height: 110px;
	background: #e2e2e2 url('2011/footer-2011.png') center;
	margin: 0 auto;
	border-top: 0 solid;
	border-right: 0 solid;
	border-bottom: 0 solid;
