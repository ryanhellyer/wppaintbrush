...
header div.header {
	...
	min-width: 400px;
	height: 110px;
	background: #ffffff url('coraline-header.png');
}
* html header .wrapper {
	width: 585px;
...
#banner div.banner-image {
	...
	min-width: 440px;
	height: 144px;
	background: url('coraline-header.jpg');
	margin: 0 auto;
	border-top: 0 solid;
	border-right: 0 solid;
	border-bottom: 0 solid;
