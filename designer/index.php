 ...
 * @since 0.8.2
 */
define( 'WPPB_DIR', get_stylesheet_directory() . '/designer/' ); // Designer framework directory
define( 'WPPB_URL', get_stylesheet_directory_uri() . '/designer/' ); // Designer framework folder URL
