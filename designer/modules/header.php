...
<div class="tab-block" id="header_options">
	<div id="tabs-header" class="inner-tabber">
		<ul>
			<li id="ptc_headeroverall_options"><a href="#headeroverall_options" title="<?php _e( 'Overall', 'wppb_lang' ); ?>"><?php _e( 'Overall', 'wppb_lang' ); ?></a></li>
			<li id="ptc_headerheading_options"><a href="#headerheading_options" title="<?php _e( 'Heading', 'wppb_lang' ); ?>"><?php _e( 'Heading', 'wppb_lang' ); ?></a></li>
			<li id="ptc_headerdescription_options"><a href="#headerdescription_options" title="<?php _e( 'Description', 'wppb_lang' ); ?>"><?php _e( 'Description', 'wppb_lang' ); ?></a></li>
			<li id="ptc_headerlogo_options"><a href="#headerlogo_options" title="<?php _e( 'Logo', 'wppb_lang' ); ?>"><?php _e( 'Logo', 'wppb_lang' ); ?></a></li>
			<li id="ptc_headersearch_options"><a href="#headersearch_options" title="<?php _e( 'Search', 'wppb_lang' ); ?>"><?php _e( 'Search', 'wppb_lang' ); ?></a></li>
		</ul>
		<div class="inner-tab-block" id="headeroverall_options">
			<div class="section-layout">
				<h2><?php _e( 'Overall', 'wppb_lang' ); ?></h2>
				<?php ptc_number_selector( 'header_max_width', $content_layout, __( 'Max width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_min_width', $content_layout, __( 'Min width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_height', $content_layout, __( 'Height', 'wppb_lang' ) ); ?>
			</div>
			<div class="section-layout">
				<h2><?php _e( 'Background', 'wppb_lang' ); ?></h2>
				<?php ptc_colour_selector( 'header_background_colour', $content_layout, __( 'Colour', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
			<div class="section-layout">
				...
				<?php ptc_display_selector( 'header_fullwidth_background_display', $content_layout, __( 'Display', 'wppb_lang' ) ); ?>
				<?php ptc_colour_selector( 'header_fullwidth_background_colour', $content_layout, __( 'Colour', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_fullwidth_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
		...
		<div class="inner-tab-block" id="headerheading_options">
			<div class="section-layout">
				...
				<?php
					ptc_display_selector( 'header_heading_display', $content_layout, __( 'Display', 'wppb_lang' ) );
					ptc_number_selector( 'header_heading_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) );
					ptc_number_selector( 'header_heading_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) );
					ptc_alignment_selector( 'header_heading_position_centered', $content_layout, __( 'Alignment', 'wppb_lang' ) );
				?>
			</div>
			<?php ptc_text_display( 'header_heading', $content_layout, __( 'Text', 'wppb_lang' ) ); ?>
		</div>
		<div class="inner-tab-block" id="headerdescription_options">
			<div class="section-layout">
				<h2><?php _e( 'Description', 'wppb_lang' ); ?></h2>
				<?php 
					ptc_display_selector( 'header_description_display', $content_layout, __( 'Display', 'wppb_lang' ) );
					ptc_number_selector( 'header_description_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) );
					ptc_number_selector( 'header_description_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) );
					ptc_alignment_selector( 'header_description_position_centered', $content_layout, __( 'Alignment', 'wppb_lang' ) );
				?>
			</div>
			<?php ptc_text_display( 'header_description', $content_layout, __( 'Text', 'wppb_lang' ) ); ?>
		</div>
		<div class="inner-tab-block" id="headerlogo_options">
			<div class="section-layout">
				<h2><?php _e( 'Logo', 'wppb_lang' ); ?></h2>
				<?php ptc_display_selector( 'header_logo_display', $content_layout, __( 'Display', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_logo_width', $content_layout, __( 'Width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_logo_height', $content_layout, __( 'Height', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_logo_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_logo_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_logo_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
		</div>
		<div class="inner-tab-block" id="headersearch_options">
			<div class="section-layout">
				<h2><?php _e( 'Search box', 'wppb_lang' ); ?></h2>
				<?php ptc_display_selector( 'header_searchbox_display', $content_layout, __( 'Display', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_width', $content_layout, __( 'Width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_height', $content_layout, __( 'Height', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) ); ?>
				<h3><?php _e( 'Background', 'wppb_lang' ); ?></h3>
				<?php ptc_colour_selector( 'header_searchbox_background_colour', $content_layout, __( 'Colour', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_searchbox_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
			<div class="section-layout">
				<h2><?php _e( 'Search text', 'wppb_lang' ); ?></h2>
				<?php ptc_text_display( 'searchtext', $content_layout, '', 'yes' ); ?>
				<h3><?php _e( 'Dimensions', 'wppb_lang' ); ?></h3>
				<?php ptc_number_selector( 'header_searchbox_text_width', $content_layout, __( 'Width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_text_height', $content_layout, __( 'Height', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_text_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchbox_text_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) ); ?>
				<h3><?php _e( 'Background', 'wppb_lang' ); ?></h3>
				<?php ptc_colour_selector( 'header_searchbox_text_background_colour', $content_layout, __( 'Colour', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_searchbox_text_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
			<div class="section-layout">
				<h2><?php _e( 'Search submit', 'wppb_lang' ); ?></h2>
				<?php ptc_display_selector( 'header_searchsubmit_text_display', $content_layout, __( 'Display text', 'wppb_lang' ) ); ?>
				<?php ptc_text_display( 'searchsubmit', $content_layout, '', 'yes' ); ?>
				<h3><?php _e( 'Dimensions', 'wppb_lang' ); ?></h3>
				<?php ptc_number_selector( 'header_searchsubmit_text_width', $content_layout, __( 'Width', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchsubmit_text_height', $content_layout, __( 'Height', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchsubmit_text_position_x', $content_layout, __( 'x-coord', 'wppb_lang' ) ); ?>
				<?php ptc_number_selector( 'header_searchsubmit_text_position_y', $content_layout, __( 'y-coord', 'wppb_lang' ) ); ?>
				<h3><?php _e( 'Background', 'wppb_lang' ); ?></h3>
				<?php ptc_colour_selector( 'header_searchsubmit_text_background_colour', $content_layout, __( 'Colour', 'wppb_lang' ) ); ?>
				<?php ptc_background_image_selector( 'header_searchsubmit_text_background_image', $content_layout, __( 'Image', 'wppb_lang' ) ); ?>
			</div>
		</div>
	</div>
</div>
